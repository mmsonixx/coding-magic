let e,t,u,s;function a(e){return e&&e.__esModule?e.default:e}function n(e){return new URL(r+(e=l.i?.[e]||e),import.meta.url).toString()}var i="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},r="./",o={},c={},l=i.parcelRequire1ad7;null==l&&((l=function(e){if(e in o)return o[e].exports;if(e in c){var t=c[e];delete c[e];var u={id:e,exports:{}};return o[e]=u,t.call(u.exports,u,u.exports),u.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){c[e]=t},i.parcelRequire1ad7=l),l.register,Object.assign(l.i??={},{"2jajS":"sonya.8ce5b47b.webp",J9Ooa:"dima.93854aff.webp","6TJib":"member.92369c67.webp","5Mkkr":"roma.63b6bfca.webp","7BdM2":"yaroslav.e4482830.webp"});var d={};d=n("2jajS");var m={};m=n("J9Ooa");var p={};p=n("6TJib");var v={};v=n("5Mkkr");var b={};b=n("7BdM2");let _=[{photo:a(d),name:"Соня",description:"Team lead, Section: Камінь-ножиці-папір,Наша команда"},{photo:a(b),name:"Ярослав",description:"Scrum Master,Section: Обери вченого/их,Перевір в який рік ти народився"},{photo:a(m),name:"Діма",description:"Developers,Section: Header,Калькулятор часу"},{photo:a(v),name:"Рома",description:"Developers,Section: Футбол,Google динозавр"},{photo:a(p),name:"Лука",description:"Developers, Section: Footer,Калькулятор"},{photo:a(p),name:"Олексій",description:"Developers,Section: Вгадай число, яке загадав комп’ютер"}],g=document.querySelector(".MD-overlay"),h=document.querySelector(".modalWindow"),y=document.querySelector(".MD-cross"),f=document.querySelector(".MD-logIn-btn"),S=document.querySelector(".MD-thanks"),E=document.querySelector(".MD-thanks-cross");function q(){g.classList.remove("active")}function w(){h.style.display="none"}window.addEventListener("DOMContentLoaded",()=>{g.classList.add("active"),h.style.display="flex"}),f&&f.addEventListener("click",e=>{e.preventDefault(),w(),S.style.display="flex"}),y&&y.addEventListener("click",()=>{w(),q()}),E&&E.addEventListener("click",()=>{S.style.display="none",q()}),e=document.querySelector(".MD-overlay"),t=document.querySelector(".MD-thanks"),u=document.querySelector(".MD-thanks-cross"),document.querySelector("[data-modal-open]"),(s=document.querySelector(".footer-sub form"))&&s.addEventListener("submit",u=>{u.preventDefault(),s.querySelector(".footer-input").checkValidity()&&(e.classList.add("active"),t.style.display="flex")}),u&&u.addEventListener("click",()=>{t.style.display="none",e.classList.remove("active")});class A{constructor(e,t){this.dino=e,this.gameArea=t,this.gameOver=!1,this.isJumping=!1,this.gameModalStart()}init(){document.addEventListener("keydown",e=>{"Space"!==e.code||this.isJumping||this.gameOver||(e.preventDefault(),this.jump())}),this.gameArea.addEventListener("mousedown",()=>{this.isJumping||this.gameOver||this.jump()}),this.renderObstacles(),this.checkCollision()}jump(){this.isJumping=!0,this.dino.classList.add("jump"),setTimeout(()=>{this.isJumping=!1,this.dino.classList.remove("jump")},500)}checkCollision(){let e=()=>{if(!0===this.gameOver)return;let t=this.gameArea.querySelector(".cactus"),u=t.getBoundingClientRect(),s=this.dino.getBoundingClientRect();s.right>u.left&&s.left<u.right&&s.bottom>u.top?this.endGame(t):requestAnimationFrame(e)};requestAnimationFrame(e)}renderObstacles(){let e=document.createElement("div");e.classList.add("cactus"),e.style.height=this.randomHeight(),this.gameArea.appendChild(e);let t=()=>{e.removeEventListener("animationend",t),e.remove(),this.gameOver||this.renderObstacles()};e.addEventListener("animationend",t)}randomHeight(){return`${Math.floor(31*Math.random()+30)}px`}endGame(e){e.style.animationPlayState="paused",this.gameOver=!0,this.gameOverModal()}createModal(e,t,u){let s=`
      <div class="dino__modal">
        <p class="dino__message">${e}</p>
        <button class="dino__start button">${t}</button>
      </div>
        `;this.gameArea.insertAdjacentHTML("beforeend",s),this.gameArea.querySelector(".dino__modal").classList.add("show"),this.gameArea.querySelector(".dino__start").addEventListener("click",u)}gameModalStart(){this.createModal("Зіграємо?","Почати гру!",()=>{let e=this.gameArea.querySelector(".dino__modal");e.classList.remove("show"),setTimeout(()=>{e.remove()},250),this.init()})}gameOverModal(){this.createModal("Ви програли!","Спробувати знову",()=>this.restartGame())}restartGame(){this.gameArea.querySelector(".dino__modal").remove(),this.gameArea.querySelector(".cactus").remove(),this.gameOver=!1,this.renderObstacles(),this.checkCollision()}}let L=document.querySelector(".dropdown__button"),x=document.querySelector(".dropdown"),M=document.querySelector(".theme-toggle__input");L&&x&&(L.onclick=function(){x.classList.toggle("is-open")}),M&&M.addEventListener("change",e=>{e.target.checked?document.body.setAttribute("data-theme","dark"):document.body.removeAttribute("data-theme")});let C=document.querySelector(".MD-logIn-input1"),k=document.getElementById("userGreeting");k&&(k.textContent="Вітаємо, Гість!"),C&&(C.value="",C.addEventListener("input",function(){let e=C.value;""==e&&(e="Гість"),k&&(k.textContent="Вітаємо, "+e+"!"),localStorage.setItem("userName",e)}));let D=[{name:"Albert",surname:"Einstein",born:1879,dead:1955,id:1},{name:"Isaac",surname:"Newton",born:1643,dead:1727,id:2},{name:"Galileo",surname:"Galilei",born:1564,dead:1642,id:3},{name:"Marie",surname:"Curie",born:1867,dead:1934,id:4},{name:"Johannes",surname:"Kepler",born:1571,dead:1630,id:5},{name:"Nicolaus",surname:"Copernicus",born:1473,dead:1543,id:6},{name:"Max",surname:"Planck",born:1858,dead:1947,id:7},{name:"Katherine",surname:"Blodgett",born:1898,dead:1979,id:8},{name:"Ada",surname:"Lovelace",born:1815,dead:1852,id:9},{name:"Sarah E.",surname:"Goode",born:1855,dead:1905,id:10},{name:"Lise",surname:"Meitner",born:1878,dead:1968,id:11},{name:"Hanna",surname:"Hammarström",born:1829,dead:1909,id:12}],$=e=>Math.ceil(e/100),F=e=>`${e.name} ${e.surname} (${e.born}-${e.dead})`,B=[{text:"Які вчені народилися в 19 ст.",title:"Вчені, що народилися в 19 столітті",action:()=>D.filter(e=>19===$(e.born))},{text:"Знайти суму років скільки прожили всі вчені",title:"Сума років життя всіх вчених",action:()=>`${D.reduce((e,t)=>e+(t.dead-t.born),0)} \u{440}\u{43E}\u{43A}\u{456}\u{432}`},{text:"Відсортувати вчених за алфавітом",title:"Сортування за алфавітом",action:()=>[...D].sort((e,t)=>e.surname.localeCompare(t.surname))},{text:"Відсортувати вчених за кількістю прожитих років",title:"Сортування за кількістю прожитих років",action:()=>[...D].sort((e,t)=>e.dead-e.born-(t.dead-t.born))},{text:"Видалити з масива вчених що народилися в 15, 16 або 17 столітті",title:"Масив без вчених з 15, 16 або 17 століття",action:()=>D.filter(e=>![15,16,17].includes($(e.born)))},{text:"Знайти вченого, який народився найпізніше",title:"Вчений, який народився найпізніше",action:()=>D.reduce((e,t)=>t.born>e.born?t:e)},{text:"Знайти рік народження Albert Einstein",title:"Рік народження Albert Einstein",action:()=>D.find(e=>"Albert"===e.name&&"Einstein"===e.surname).born},{text:"Знайти вчених, прізвища яких починаються на літеру “C”",title:"Прізвища починаються на C",action:()=>D.filter(e=>e.surname.startsWith("C"))},{text:"Видалити всіх вчених, ім’я яких починається на “A”",title:"Масив без імен на A",action:()=>D.filter(e=>!e.name.startsWith("A"))},{text:"Знайти вченого, який прожив найдовше і вченого, який прожив найменше",title:"Найдовше і найменше життя",action:()=>{let e,t;return e=D.reduce((e,t)=>t.dead-t.born>e.dead-e.born?t:e),t=D.reduce((e,t)=>t.dead-t.born<e.dead-e.born?t:e),[`\u{41D}\u{430}\u{439}\u{434}\u{43E}\u{432}\u{448}\u{435} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432}: ${F(e)}`,`\u{41D}\u{430}\u{439}\u{43C}\u{435}\u{43D}\u{448}\u{435} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432}: ${F(t)}`]}},{text:"Знайти вчених, в яких співпадають перші літери імені і прізвища",title:"Однакові перші літери імені та прізвища",action:()=>D.filter(e=>e.name[0]===e.surname[0])},{text:"Дізнатися чи всі вчені працювали в 19 столітті",title:"Чи всі вчені працювали в 19 столітті",action:()=>D.every(e=>e.born<=1900&&e.dead>=1801)?"Так, всі вчені працювали в 19 столітті":"Ні, не всі вчені працювали в 19 столітті"}],H=[{id:1,name:"Високосний калькулятор",category:"numerical",init:function(){let e=document.querySelector("#game-1");if(!e)return;e.innerHTML=`
  ...
  `;let a=e.querySelectorAll(".rps__item"),n=e.querySelector(".rps__info"),i=e.querySelector("#computerScore"),r=e.querySelector("#userScore");a.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.choice,o=s[Math.floor(Math.random()*s.length)],c=a===o?"draw":"Камінь"===a&&"Ножиці"===o||"Ножиці"===a&&"Папір"===o||"Папір"===a&&"Камінь"===o?"user":"computer";"user"===c?t++:"computer"===c&&u++,n.textContent=`${o}`,i.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}\u{2019}\u{44E}\u{442}\u{435}\u{440} - ${u}`,r.textContent=`\u{412}\u{438} - ${t}`})})}},{id:4,name:"Калькулятор",category:"numerical",init:function(){document.querySelector("#game-4").innerHTML=`<section class="section section-4">
      <div class="container">
...
<div class="divider"></div>
  ...
  `;let t=e.querySelector("#calcBtn"),u=e.querySelector("#secondsInput"),s=e.querySelector("#timeResult");function a(){let e=parseInt(u.value,10);if(isNaN(e)||e<0){s&&(s.textContent="0 дн. 00:00:00");return}let t=Math.floor(e/86400),a=e%86400,n=Math.floor(a/3600),i=Math.floor((a%=3600)/60),r=a%60;n<10&&(n="0"+n),i<10&&(i="0"+i),r<10&&(r="0"+r),s&&(s.textContent=t+" дн. "+n+":"+i+":"+r)}t&&u&&(t.onclick=function(){a()},u.onkeypress=function(e){"Enter"===e.key&&a()})}},{id:6,name:"Google динозаврик",category:"game",init:function(){document.querySelector("#game-6").innerHTML=`
    ...
    `;let e=document.querySelector("#dinoGameArea");new A(document.querySelector("#dino"),e)}},{id:7,name:"Футбол",category:"game"},{id:8,name:"Найбільше число",category:"numerical",init:function(){let e=document.querySelector("#game-2");if(!e)return;e.innerHTML=`
  ...
  `,e.querySelectorAll("[data-scientist-task]").forEach(t=>{t.addEventListener("click",t=>{let u=B[Number(t.currentTarget.dataset.scientistTask)],s=u.action();e.querySelector("[data-scientist-answer]").innerHTML=`
      ...
      ${s.map(e=>`<li>${"string"==typeof e?e:F(e)}</li>`).join("")}
    </ul>`:"object"==typeof s?`<p class="guess-scientist__answer-text">${F(s)}</p>`:`<p class="guess-scientist__answer-text">${s}</p>`}
      `})}))}}],T=document.querySelector("[data-game-container]"),N=document.querySelectorAll(".dropdown__link");function O(e,t){if(!t)return void console.error("Контейнер не знайдено");if(0===e.length){t.innerHTML='<p class="no-games">Ігор у цій категорії поки немає</p>';return}t.innerHTML=e.reduce((e,t)=>e+`
    ...
    `,""),e.forEach(e=>{e.init&&e.init()})}O(H,T),N.forEach(e=>{e.addEventListener("click",e=>{e.preventDefault();let t=e.target.dataset.category;O("all"===t?H:H.filter(e=>e.category===t),T)})});
//# sourceMappingURL=coding-magic.fd5b06da.js.map
