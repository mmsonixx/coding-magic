var e;let t=document.querySelector(".MD-overlay"),u=document.querySelector(".modalWindow"),c=document.querySelector(".MD-cross"),n=document.querySelector(".MD-logIn-btn"),s=document.querySelector(".MD-thanks"),l=document.querySelector(".MD-thanks-cross");function a(){t.classList.remove("active")}function o(){u.style.display="none"}window.addEventListener("DOMContentLoaded",()=>{t.classList.add("active"),u.style.display="flex"}),n&&n.addEventListener("click",e=>{e.preventDefault(),o(),s.style.display="flex"}),c&&c.addEventListener("click",()=>{o(),a()}),l&&l.addEventListener("click",()=>{s.style.display="none",a()});let i=[{id:1,name:"Високосний калькулятор",category:"numerical"},{id:2,name:"Вгадай число",category:"numerical"},{id:3,name:"Камінь-Ножиці-Папір",category:"game",init:function(){document.querySelector("#game-3").innerHTML=`<section class="rockPaperScissors">
    <div class="container">
...
<div class="divider"></div>
    ...
    </section>`;let e=document.querySelector(".calc-input"),t=document.querySelector(".calc-input-second"),u=document.querySelector("input[readonly]"),c=document.querySelector(".calc-equal"),n=document.querySelectorAll(".calc-button"),s="+";n.forEach(e=>{e.addEventListener("click",()=>{s=e.textContent})}),c.addEventListener("click",()=>{let c,n=Number(e.value),l=Number(t.value);if(isNaN(n)||isNaN(l)){u.value="";return}switch(s){case"+":c=n+l;break;case"-":c=n-l;break;case"*":c=n*l;break;case"/":c=0!==l?n/l:alert("ашiбачка, введите правильные числа ")}u.value=c})}},{id:5,name:"Калькулятор часу",category:"numerical"},{id:6,name:"Google динозаврик",category:"game"},{id:7,name:"Футбол",category:"game"},{id:8,name:"Найбільше число",category:"numerical"},{id:9,name:"Наша команда",category:"acquaintance"},{id:10,name:"Вчений",category:"acquaintance"}],r=document.querySelector("[data-game-container]");r?(r.innerHTML=i.reduce((e,t)=>e+=`<section class="section section-${t.id}">
...
<div class="container">
  ...
  <div class="game" id="game-${t.id}">
        ...
        </section>`,""),i.forEach(e=>{e.init&&e.init()})):console.error("контейнер незнайдено");let d=document.querySelector(".dropdown__button"),m=document.querySelector(".dropdown"),v=document.querySelector(".theme-toggle__input");d.onclick=function(){m.classList.toggle("is-open")},document.querySelector(".theme-toggle__input"),v.addEventListener("change",e=>{e.target.checked?document.body.setAttribute("data-theme","dark"):document.body.removeAttribute("data-theme")});let p=document.querySelector(".MD-logIn-input1"),y=document.getElementById("userGreeting");y.textContent="Вітаємо, Гість!",p.value="",p.addEventListener("input",function(){let e=p.value;""==e&&(e="Гість"),y.textContent="Вітаємо, "+e+"!",localStorage.setItem("userName",e)});let g=document.querySelector("#game-5");e=`
  <div class="container">
  ...
  `,g?g.innerHTML=e:console.log("Упс! Немає такого контейнера");let _=document.getElementById("calcBtn"),b=document.getElementById("secondsInput");function h(){let e=parseInt(b.value,10);if(isNaN(e)||e<0){document.getElementById("timeResult").textContent="0 дн. 00:00:00";return}let t=Math.floor(e/86400),u=e%86400,c=Math.floor(u/3600),n=Math.floor((u%=3600)/60),s=u%60;c<10&&(c="0"+c),n<10&&(n="0"+n),s<10&&(s="0"+s),document.getElementById("timeResult").textContent=t+" дн. "+c+":"+n+":"+s}_&&b&&(_.onclick=function(){h()},b.onkeypress=function(e){"Enter"==e.key&&h()});
//# sourceMappingURL=coding-magic.8a20af20.js.map
