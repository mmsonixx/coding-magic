let e,t,u,s;function a(e){return e&&e.__esModule?e.default:e}function n(e){return new URL(r+(e=l.i?.[e]||e),import.meta.url).toString()}var i="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},r="./",c={},o={},l=i.parcelRequire1ad7;null==l&&((l=function(e){if(e in c)return c[e].exports;if(e in o){var t=o[e];delete o[e];var u={id:e,exports:{}};return c[e]=u,t.call(u.exports,u,u.exports),u.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){o[e]=t},i.parcelRequire1ad7=l),l.register,Object.assign(l.i??={},{"2jajS":"sonya.8ce5b47b.webp",J9Ooa:"dima.93854aff.webp","5Mkkr":"roma.63b6bfca.webp","7BdM2":"yaroslav.e4482830.webp"});var d={};d=n("2jajS");var m={};m=n("J9Ooa");var p={};p=n("5Mkkr");var v={};v=n("7BdM2");let b=[{photo:a(d),name:"Соня",description:"Team lead, Section: Камінь-ножиці-папір,Наша команда"},{photo:a(v),name:"Ярослав",description:"Scrum Master,Section: Обери вченого/их,Перевір в який рік ти народився"},{photo:a(m),name:"Діма",description:"Developers,Section: Header,Калькулятор часу"},{photo:a(p),name:"Рома",description:"Developers,Section: Футбол,Google динозавр"},{photo:a(d),name:"Лука",description:"Developers, Section: Footer,Калькулятор"},{photo:a(d),name:"Олексій",description:"Developers,Section: Вгадай число, яке загадав комп’ютер"}],_=document.querySelector(".MD-overlay"),y=document.querySelector(".modalWindow"),g=document.querySelector(".MD-cross"),h=document.querySelector(".MD-logIn-btn"),f=document.querySelector(".MD-thanks"),E=document.querySelector(".MD-thanks-cross");function S(){_.classList.remove("active")}function w(){y.style.display="none"}window.addEventListener("DOMContentLoaded",()=>{_.classList.add("active"),y.style.display="flex"}),h&&h.addEventListener("click",e=>{e.preventDefault(),w(),f.style.display="flex"}),g&&g.addEventListener("click",()=>{w(),S()}),E&&E.addEventListener("click",()=>{f.style.display="none",S()}),e=document.querySelector(".MD-overlay"),t=document.querySelector(".MD-thanks"),u=document.querySelector(".MD-thanks-cross"),document.querySelector("[data-modal-open]"),(s=document.querySelector(".footer-sub form"))&&s.addEventListener("submit",u=>{u.preventDefault(),s.querySelector(".footer-input").checkValidity()&&(e.classList.add("active"),t.style.display="flex")}),u&&u.addEventListener("click",()=>{t.style.display="none",e.classList.remove("active")});let x=document.querySelector(".dropdown__button"),q=document.querySelector(".dropdown"),L=document.querySelector(".theme-toggle__input");x&&q&&(x.onclick=function(){q.classList.toggle("is-open")}),L&&L.addEventListener("change",e=>{e.target.checked?document.body.setAttribute("data-theme","dark"):document.body.removeAttribute("data-theme")});let k=document.querySelector(".MD-logIn-input1"),A=document.getElementById("userGreeting");A&&(A.textContent="Вітаємо, Гість!"),k&&(k.value="",k.addEventListener("input",function(){let e=k.value;""==e&&(e="Гість"),A&&(A.textContent="Вітаємо, "+e+"!"),localStorage.setItem("userName",e)}));let C=[{name:"Albert",surname:"Einstein",born:1879,dead:1955,id:1},{name:"Isaac",surname:"Newton",born:1643,dead:1727,id:2},{name:"Galileo",surname:"Galilei",born:1564,dead:1642,id:3},{name:"Marie",surname:"Curie",born:1867,dead:1934,id:4},{name:"Johannes",surname:"Kepler",born:1571,dead:1630,id:5},{name:"Nicolaus",surname:"Copernicus",born:1473,dead:1543,id:6},{name:"Max",surname:"Planck",born:1858,dead:1947,id:7},{name:"Katherine",surname:"Blodgett",born:1898,dead:1979,id:8},{name:"Ada",surname:"Lovelace",born:1815,dead:1852,id:9},{name:"Sarah E.",surname:"Goode",born:1855,dead:1905,id:10},{name:"Lise",surname:"Meitner",born:1878,dead:1968,id:11},{name:"Hanna",surname:"Hammarström",born:1829,dead:1909,id:12}],M=e=>Math.ceil(e/100),D=e=>`${e.name} ${e.surname} (${e.born}-${e.dead})`,$=[{text:"Які вчені народилися в 19 ст.",title:"Вчені, що народилися в 19 столітті",action:()=>C.filter(e=>19===M(e.born))},{text:"Знайти суму років скільки прожили всі вчені",title:"Сума років життя всіх вчених",action:()=>`${C.reduce((e,t)=>e+(t.dead-t.born),0)} \u{440}\u{43E}\u{43A}\u{456}\u{432}`},{text:"Відсортувати вчених за алфавітом",title:"Сортування за алфавітом",action:()=>[...C].sort((e,t)=>e.surname.localeCompare(t.surname))},{text:"Відсортувати вчених за кількістю прожитих років",title:"Сортування за кількістю прожитих років",action:()=>[...C].sort((e,t)=>e.dead-e.born-(t.dead-t.born))},{text:"Видалити з масива вчених що народилися в 15, 16 або 17 столітті",title:"Масив без вчених з 15, 16 або 17 століття",action:()=>C.filter(e=>![15,16,17].includes(M(e.born)))},{text:"Знайти вченого, який народився найпізніше",title:"Вчений, який народився найпізніше",action:()=>C.reduce((e,t)=>t.born>e.born?t:e)},{text:"Знайти рік народження Albert Einstein",title:"Рік народження Albert Einstein",action:()=>C.find(e=>"Albert"===e.name&&"Einstein"===e.surname).born},{text:"Знайти вчених, прізвища яких починаються на літеру “C”",title:"Прізвища починаються на C",action:()=>C.filter(e=>e.surname.startsWith("C"))},{text:"Видалити всіх вчених, ім’я яких починається на “A”",title:"Масив без імен на A",action:()=>C.filter(e=>!e.name.startsWith("A"))},{text:"Знайти вченого, який прожив найдовше і вченого, який прожив найменше",title:"Найдовше і найменше життя",action:()=>{let e,t;return e=C.reduce((e,t)=>t.dead-t.born>e.dead-e.born?t:e),t=C.reduce((e,t)=>t.dead-t.born<e.dead-e.born?t:e),[`\u{41D}\u{430}\u{439}\u{434}\u{43E}\u{432}\u{448}\u{435} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432}: ${D(e)}`,`\u{41D}\u{430}\u{439}\u{43C}\u{435}\u{43D}\u{448}\u{435} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432}: ${D(t)}`]}},{text:"Знайти вчених, в яких співпадають перші літери імені і прізвища",title:"Однакові перші літери імені та прізвища",action:()=>C.filter(e=>e.name[0]===e.surname[0])},{text:"Дізнатися чи всі вчені працювали в 19 столітті",title:"Чи всі вчені працювали в 19 столітті",action:()=>C.every(e=>e.born<=1900&&e.dead>=1801)?"Так, всі вчені працювали в 19 столітті":"Ні, не всі вчені працювали в 19 столітті"}],F=[{id:1,name:"Високосний калькулятор",category:"numerical",init:function(){let e=document.querySelector("#game-1");if(!e)return;e.innerHTML=`
  ...
  `;let a=e.querySelectorAll(".rps__item"),n=e.querySelector(".rps__info"),i=e.querySelector("#computerScore"),r=e.querySelector("#userScore");a.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.choice,c=s[Math.floor(Math.random()*s.length)],o=a===c?"draw":"Камінь"===a&&"Ножиці"===c||"Ножиці"===a&&"Папір"===c||"Папір"===a&&"Камінь"===c?"user":"computer";"user"===o?t++:"computer"===o&&u++,n.textContent=`${c}`,i.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}\u{2019}\u{44E}\u{442}\u{435}\u{440} - ${u}`,r.textContent=`\u{412}\u{438} - ${t}`})})}},{id:4,name:"Калькулятор",category:"numerical",init:function(){document.querySelector("#game-4").innerHTML=`<section class="section section-4">
      <div class="container">
...
<div class="divider"></div>
    ...
    <div class="divider"></div>
  `;let t=e.querySelector("#calcBtn"),u=e.querySelector("#secondsInput"),s=e.querySelector("#timeResult");function a(){let e=parseInt(u.value,10);if(isNaN(e)||e<0){s&&(s.textContent="0 дн. 00:00:00");return}let t=Math.floor(e/86400),a=e%86400,n=Math.floor(a/3600),i=Math.floor((a%=3600)/60),r=a%60;n<10&&(n="0"+n),i<10&&(i="0"+i),r<10&&(r="0"+r),s&&(s.textContent=t+" дн. "+n+":"+i+":"+r)}t&&u&&(t.onclick=function(){a()},u.onkeypress=function(e){"Enter"===e.key&&a()})}},{id:6,name:"Google динозаврик",category:"game"},{id:7,name:"Футбол",category:"game"},{id:8,name:"Найбільше число",category:"numerical",init:function(){let e=document.querySelector("#game-2");if(!e)return;e.innerHTML=`
...
//# sourceMappingURL=coding-magic.257ddb1c.js.map
