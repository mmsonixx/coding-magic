let e,t,u,s;var a="u">typeof globalThis?globalThis:"u">typeof self?self:"u">typeof window?window:"u">typeof global?global:{},n={},i={},r=a.parcelRequire1ad7;null==r&&((r=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var u={id:e,exports:{}};return n[e]=u,t.call(u.exports,u,u.exports),u.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){i[e]=t},a.parcelRequire1ad7=r),r.register,Object.assign(r.i??={},{brgVf:"cat.4c9b4236.webp"});let c=[{photo:{},name:"Sonya",description:"Team lead,"}];new Swiper(".swiper",{effect:"creative",creativeEffect:{prev:{translate:["-80%",0,0],scale:.5},next:{translate:["80%",0,0],scale:.5}},loop:!0,slidesPerView:3,centeredSlides:!0,pagination:{el:".swiper-pagination",type:"bullets",clickable:!0},navigation:{nextEl:".swiper-button-next",prevEl:".swiper-button-prev"},breakpoints:{320:{slidesPerView:1},768:{slidesPerView:1.2},1200:{slidesPerView:1.5}}});let l=document.querySelector(".MD-overlay"),o=document.querySelector(".modalWindow"),d=document.querySelector(".MD-cross"),p=document.querySelector(".MD-logIn-btn"),m=document.querySelector(".MD-thanks"),v=document.querySelector(".MD-thanks-cross");function y(){l.classList.remove("active")}function b(){o.style.display="none"}window.addEventListener("DOMContentLoaded",()=>{l.classList.add("active"),o.style.display="flex"}),p&&p.addEventListener("click",e=>{e.preventDefault(),b(),m.style.display="flex"}),d&&d.addEventListener("click",()=>{b(),y()}),v&&v.addEventListener("click",()=>{m.style.display="none",y()}),e=document.querySelector(".MD-overlay"),t=document.querySelector(".MD-thanks"),u=document.querySelector(".MD-thanks-cross"),(s=document.querySelector("[data-modal-open]"))&&s.addEventListener("click",()=>{e.classList.add("active"),t.style.display="flex"}),u&&u.addEventListener("click",()=>{t.style.display="none",e.classList.remove("active")});let _=document.querySelector(".dropdown__button"),g=document.querySelector(".dropdown"),f=document.querySelector(".theme-toggle__input");_&&g&&(_.onclick=function(){g.classList.toggle("is-open")}),f&&f.addEventListener("change",e=>{e.target.checked?document.body.setAttribute("data-theme","dark"):document.body.removeAttribute("data-theme")});let h=document.querySelector(".MD-logIn-input1"),E=document.getElementById("userGreeting");E&&(E.textContent="Вітаємо, Гість!"),h&&(h.value="",h.addEventListener("input",function(){let e=h.value;""==e&&(e="Гість"),E&&(E.textContent="Вітаємо, "+e+"!"),localStorage.setItem("userName",e)}));let S=[{name:"Albert",surname:"Einstein",born:1879,dead:1955,id:1},{name:"Isaac",surname:"Newton",born:1643,dead:1727,id:2},{name:"Galileo",surname:"Galilei",born:1564,dead:1642,id:3},{name:"Marie",surname:"Curie",born:1867,dead:1934,id:4},{name:"Johannes",surname:"Kepler",born:1571,dead:1630,id:5},{name:"Nicolaus",surname:"Copernicus",born:1473,dead:1543,id:6},{name:"Max",surname:"Planck",born:1858,dead:1947,id:7},{name:"Katherine",surname:"Blodgett",born:1898,dead:1979,id:8},{name:"Ada",surname:"Lovelace",born:1815,dead:1852,id:9},{name:"Sarah E.",surname:"Goode",born:1855,dead:1905,id:10},{name:"Lise",surname:"Meitner",born:1878,dead:1968,id:11},{name:"Hanna",surname:"Hammarström",born:1829,dead:1909,id:12}],x=e=>Math.ceil(e/100),w=e=>`${e.name} ${e.surname} (${e.born}-${e.dead})`,q=[{text:"Які вчені народилися в 19 ст.",title:"Вчені, що народилися в 19 столітті",action:()=>S.filter(e=>19===x(e.born))},{text:"Знайти суму років скільки прожили всі вчені",title:"Сума років життя всіх вчених",action:()=>`${S.reduce((e,t)=>e+(t.dead-t.born),0)} \u{440}\u{43E}\u{43A}\u{456}\u{432}`},{text:"Відсортувати вчених за алфавітом",title:"Сортування за алфавітом",action:()=>[...S].sort((e,t)=>e.surname.localeCompare(t.surname))},{text:"Відсортувати вчених за кількістю прожитих років",title:"Сортування за кількістю прожитих років",action:()=>[...S].sort((e,t)=>e.dead-e.born-(t.dead-t.born))},{text:"Видалити з масива вчених що народилися в 15, 16 або 17 столітті",title:"Масив без вчених з 15, 16 або 17 століття",action:()=>S.filter(e=>![15,16,17].includes(x(e.born)))},{text:"Знайти вченого, який народився найпізніше",title:"Вчений, який народився найпізніше",action:()=>S.reduce((e,t)=>t.born>e.born?t:e)},{text:"Знайти рік народження Albert Einstein",title:"Рік народження Albert Einstein",action:()=>S.find(e=>"Albert"===e.name&&"Einstein"===e.surname).born},{text:"Знайти вчених, прізвища яких починаються на літеру “C”",title:"Прізвища починаються на C",action:()=>S.filter(e=>e.surname.startsWith("C"))},{text:"Видалити всіх вчених, ім’я яких починається на “A”",title:"Масив без імен на A",action:()=>S.filter(e=>!e.name.startsWith("A"))},{text:"Знайти вченого, який прожив найдовше і вченого, який прожив найменше",title:"Найдовше і найменше життя",action:()=>{let e,t;return e=S.reduce((e,t)=>t.dead-t.born>e.dead-e.born?t:e),t=S.reduce((e,t)=>t.dead-t.born<e.dead-e.born?t:e),[`\u{41D}\u{430}\u{439}\u{434}\u{43E}\u{432}\u{448}\u{435} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432}: ${w(e)}`,`\u{41D}\u{430}\u{439}\u{43C}\u{435}\u{43D}\u{448}\u{435} \u{43F}\u{440}\u{43E}\u{436}\u{438}\u{432}: ${w(t)}`]}},{text:"Знайти вчених, в яких співпадають перші літери імені і прізвища",title:"Однакові перші літери імені та прізвища",action:()=>S.filter(e=>e.name[0]===e.surname[0])},{text:"Дізнатися чи всі вчені працювали в 19 столітті",title:"Чи всі вчені працювали в 19 столітті",action:()=>S.every(e=>e.born<=1900&&e.dead>=1801)?"Так, всі вчені працювали в 19 столітті":"Ні, не всі вчені працювали в 19 столітті"}],L=[{id:1,name:"Високосний калькулятор",category:"numerical",init:function(){let e=document.querySelector("#game-1");if(!e)return;e.innerHTML=`
  ...
  `;let a=e.querySelectorAll(".rps__item"),n=e.querySelector(".rps__info"),i=e.querySelector("#computerScore"),r=e.querySelector("#userScore");a.forEach(e=>{e.addEventListener("click",()=>{let a=e.dataset.choice,c=s[Math.floor(Math.random()*s.length)],l=a===c?"draw":"Камінь"===a&&"Ножиці"===c||"Ножиці"===a&&"Папір"===c||"Папір"===a&&"Камінь"===c?"user":"computer";"user"===l?t++:"computer"===l&&u++,n.textContent=`${c}`,i.textContent=`\u{41A}\u{43E}\u{43C}\u{43F}\u{2019}\u{44E}\u{442}\u{435}\u{440} - ${u}`,r.textContent=`\u{412}\u{438} - ${t}`})})}},{id:4,name:"Калькулятор",category:"numerical",init:function(){document.querySelector("#game-4").innerHTML=`<section class="section section-4">
      <div class="container">
...
<div class="divider"></div>
  ...
  `;let t=e.querySelector("#calcBtn"),u=e.querySelector("#secondsInput"),s=e.querySelector("#timeResult");function a(){let e=parseInt(u.value,10);if(isNaN(e)||e<0){s&&(s.textContent="0 дн. 00:00:00");return}let t=Math.floor(e/86400),a=e%86400,n=Math.floor(a/3600),i=Math.floor((a%=3600)/60),r=a%60;n<10&&(n="0"+n),i<10&&(i="0"+i),r<10&&(r="0"+r),s&&(s.textContent=t+" дн. "+n+":"+i+":"+r)}t&&u&&(t.onclick=function(){a()},u.onkeypress=function(e){"Enter"===e.key&&a()})}},{id:6,name:"Google динозаврик",category:"game"},{id:7,name:"Футбол",category:"game"},{id:8,name:"Найбільше число",category:"numerical",init:initTheBiggestNumber},{id:9,name:"Наша команда",category:"acquaintance",init:function(){document.querySelector("#game-9").innerHTML=`
  ...
  `,e.querySelectorAll("[data-scientist-task]").forEach(t=>{t.addEventListener("click",t=>{let u=q[Number(t.currentTarget.dataset.scientistTask)],s=u.action();e.querySelector("[data-scientist-answer]").innerHTML=`
      ...
      `})}))}}],A=document.querySelector("[data-game-container]"),k=document.querySelectorAll(".dropdown__link");function C(e,t){if(!t)return void console.error("Контейнер не знайдено");if(0===e.length){t.innerHTML='<p class="no-games">Ігор у цій категорії поки немає</p>';return}t.innerHTML=e.reduce((e,t)=>e+`
    ...
    `,""),e.forEach(e=>{e.init&&e.init()})}C(L,A),k.forEach(e=>{e.addEventListener("click",e=>{e.preventDefault();let t=e.target.dataset.category;C("all"===t?L:L.filter(e=>e.category===t),A)})});
//# sourceMappingURL=coding-magic.c0beaf96.js.map
